...
let vncClient: typeof VncClient | undefined
...
function handleDisconnectionEvent() {
    ...
    if (props.isConsoleAvailable) {
        ...
        console.error(
            `Connection lost for the remote console: ${props.url}. New attempt in ${FIBONACCI_MS_ARRAY[nConnectionAttempts - 1]
            }ms`
        )
        createVncConnection()
    }
